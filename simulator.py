        ...
        if self.display:
            try:
                ...
                for agent in self.env.agent_states:
                    agent._sprite = self.pygame.transform.smoothscale(self.pygame.image.load("C:\Users\gautham\Documents\machine-learning-master\machine-learning-master\projects\smartcab\images\car-{}.png".format(agent.color)), self.agent_sprite_size)
